...
class addressModel(models.Model):
    ...
    province=models.CharField('省份',max_length=30,default='')
    city=models.CharField('市',max_length=30,default='')
    ...
    signer_mobile=models.CharField('联系电话',max_length=100,default='')
